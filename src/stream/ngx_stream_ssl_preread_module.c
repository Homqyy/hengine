...
static ngx_command_t ngx_stream_ssl_preread_commands[] = {
    ...
    {ngx_string("ssl_preread"),
     ...
     offsetof(ngx_stream_ssl_preread_srv_conf_t, enabled), NULL},
                                         ...
                                         uintptr_t             data)
{
    ...
    case 0:
        ...
        {
        case 2: ngx_str_set(&version, "SSLv2"); break;
        }
        break;
    case 3:
        switch (ctx->version[1])
        {
        case 0: ngx_str_set(&version, "SSLv3"); break;
        case 1: ngx_str_set(&version, "TLSv1"); break;
        case 2: ngx_str_set(&version, "TLSv1.1"); break;
        case 3: ngx_str_set(&version, "TLSv1.2"); break;
        case 4: ngx_str_set(&version, "TLSv1.3"); break;
        }
    }
