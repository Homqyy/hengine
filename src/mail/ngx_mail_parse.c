    ...
    for (p = s->buffer->pos; p < s->buffer->last; p++)
    {
        ...
        case sw_start:
            ...
            case ' ':
                ...
                break;
            case CR: s->state = sw_start; return NGX_MAIL_PARSE_INVALID_COMMAND;
            case LF: s->state = sw_start; return NGX_MAIL_PARSE_INVALID_COMMAND;
            }
            break;
        ...
        case sw_backslash:
            ...
            {
            case CR:
            case LF: goto invalid;
            default: state = sw_argument;
            }
            break;
        ...
        case sw_end_literal_argument:
            ...
            case CR: state = sw_almost_done; break;
            case LF: goto done;
            default: state = sw_spaces_before_argument; break;
            }
            break;
