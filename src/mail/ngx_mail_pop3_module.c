...
static ngx_str_t ngx_mail_pop3_default_capabilities[] = {
    ngx_string("TOP"), ngx_string("USER"), ngx_string("UIDL"), ngx_null_string};
...
static ngx_command_t ngx_mail_pop3_commands[] = {
    ...
    {ngx_string("pop3_capabilities"),
     ...
     offsetof(ngx_mail_pop3_srv_conf_t, capabilities), NULL},
...
ngx_mail_pop3_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    ngx_conf_merge_bitmask_value(
        conf->auth_methods, prev->auth_methods,
        (NGX_CONF_BITMASK_SET | NGX_MAIL_AUTH_PLAIN_ENABLED));
    ...
    size =
        sizeof("+OK Capability list follows" CRLF) - 1 + sizeof("." CRLF) - 1;
