...
static ngx_str_t ngx_mail_imap_default_capabilities[] = {
    ngx_string("IMAP4"), ngx_string("IMAP4rev1"), ngx_string("UIDPLUS"),
    ngx_null_string};
...
static ngx_command_t ngx_mail_imap_commands[] = {
    ...
    {ngx_string("imap_client_buffer"),
     ...
     offsetof(ngx_mail_imap_srv_conf_t, client_buffer_size), NULL},

    {ngx_string("imap_capabilities"),
     NGX_MAIL_MAIN_CONF | NGX_MAIL_SRV_CONF | NGX_CONF_1MORE,
     ngx_mail_capabilities, NGX_MAIL_SRV_CONF_OFFSET,
     offsetof(ngx_mail_imap_srv_conf_t, capabilities), NULL},
