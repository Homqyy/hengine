...
static char     *ngx_http_charset_merge_loc_conf(ngx_conf_t *cf, void *parent,
                                                 void *child);
...
static ngx_command_t ngx_http_charset_filter_commands[] = {
    ...
    {ngx_string("charset"),
     ...
     ngx_http_set_charset_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_charset_loc_conf_t, charset), NULL},

    {ngx_string("source_charset"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF
         | NGX_HTTP_LIF_CONF | NGX_CONF_TAKE1,
     ngx_http_set_charset_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_charset_loc_conf_t, source_charset), NULL},

    {ngx_string("override_charset"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF
         | NGX_HTTP_LIF_CONF | NGX_CONF_FLAG,
     ngx_conf_set_flag_slot, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_charset_loc_conf_t, override_charset), NULL},
    ...
    {ngx_string("charset_map"),
     ...
     ngx_http_charset_map_block, NGX_HTTP_MAIN_CONF_OFFSET, 0, NULL},
                            ...
                            size_t size)
{
    ...
    for (ll = &ctx->free_buffers, cl = ctx->free_buffers; cl;
...
ngx_http_set_charset_slot(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    mcf =
        ngx_http_conf_get_module_main_conf(cf, ngx_http_charset_filter_module);
