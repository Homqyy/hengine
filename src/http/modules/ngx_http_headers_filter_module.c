...
static char     *ngx_http_headers_merge_conf(ngx_conf_t *cf, void *parent,
                                             void *child);
...
static ngx_command_t ngx_http_headers_filter_commands[] = {
    ...
    {ngx_string("add_header"),
     ...
     ngx_http_headers_add, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_headers_conf_t, headers), NULL},

    {ngx_string("add_trailer"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF
         | NGX_HTTP_LIF_CONF | NGX_CONF_TAKE23,
     ngx_http_headers_add, NGX_HTTP_LOC_CONF_OFFSET,
     offsetof(ngx_http_headers_conf_t, trailers), NULL},
...
ngx_http_headers_filter(ngx_http_request_t *r)
{
    ...
    case NGX_HTTP_PERMANENT_REDIRECT: safe_status = 1; break;
...
ngx_http_set_expires(ngx_http_request_t *r, ngx_http_headers_conf_t *conf)
{
    ...
    cc->value.len =
        ngx_sprintf(cc->value.data, "max-age=%T", max_age) - cc->value.data;
