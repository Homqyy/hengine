...
static ngx_command_t ngx_http_upstream_random_commands[] = {
    ...
    {ngx_string("random"),
     ...
     ngx_http_upstream_random, NGX_HTTP_SRV_CONF_OFFSET, 0, NULL},
...
ngx_http_upstream_get_random_peer(ngx_peer_connection_t *pc, void *data)
{
    ...
    ngx_log_debug1(NGX_LOG_DEBUG_HTTP, pc->log, 0, "get random peer, try: %ui",
                   pc->tries);
...
ngx_http_upstream_get_random2_peer(ngx_peer_connection_t *pc, void *data)
{
    ...
    ngx_log_debug1(NGX_LOG_DEBUG_HTTP, pc->log, 0, "get random2 peer, try: %ui",
                   pc->tries);
