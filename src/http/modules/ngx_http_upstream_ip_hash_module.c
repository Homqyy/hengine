...
static ngx_command_t ngx_http_upstream_ip_hash_commands[] = {
    ...
    {ngx_string("ip_hash"), NGX_HTTP_UPS_CONF | NGX_CONF_NOARGS,
     ngx_http_upstream_ip_hash, 0, 0, NULL},
...
ngx_http_upstream_get_ip_hash_peer(ngx_peer_connection_t *pc, void *data)
{
    ...
    ngx_log_debug1(NGX_LOG_DEBUG_HTTP, pc->log, 0, "get ip hash peer, try: %ui",
                   pc->tries);
    ...
    for (;;)
    {
        ...
        ngx_log_debug1(NGX_LOG_DEBUG_HTTP, pc->log, 0,
                       "get ip_hash peer, check_index: %ui", peer->check_index);
