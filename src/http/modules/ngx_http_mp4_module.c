                       ...
                       uint64_t                     atom_data_size)
{
    ...
    while (mp4->offset < end)
    {
        ...
        ngx_log_debug4(NGX_LOG_DEBUG_HTTP, mp4->file.log, 0,
                       "mp4 atom: %*s @%O:%uL", (size_t)4, atom_name,
                       mp4->offset, atom_size);
...
ngx_http_mp4_read_trak_atom(ngx_http_mp4_file_t *mp4, uint64_t atom_data_size)
{
    ...
    ngx_log_debug1(NGX_LOG_DEBUG_HTTP, mp4->file.log, 0, "mp4 trak atom: %i",
                   rc);
...
static ngx_int_t
ngx_http_mp4_crop_stts_data(ngx_http_mp4_file_t *mp4, ngx_http_mp4_trak_t *trak,
                            ngx_uint_t start)
{
...
static void
ngx_http_mp4_crop_stss_data(ngx_http_mp4_file_t *mp4, ngx_http_mp4_trak_t *trak,
                            ngx_uint_t start)
{
    uint32_t   sample, start_sample, *entry, *end;
    ngx_buf_t *data;
    ...
    while (entry < end)
    {
        ...
        ngx_log_debug1(NGX_LOG_DEBUG_HTTP, mp4->file.log, 0, "sync:%uD",
                       sample);
...
static void
ngx_http_mp4_crop_ctts_data(ngx_http_mp4_file_t *mp4, ngx_http_mp4_trak_t *trak,
                            ngx_uint_t start)
{
...
static ngx_int_t
ngx_http_mp4_crop_stsc_data(ngx_http_mp4_file_t *mp4, ngx_http_mp4_trak_t *trak,
                            ngx_uint_t start)
{
