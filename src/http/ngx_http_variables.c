...
static ngx_int_t ngx_http_variable_full_request(ngx_http_request_t        *r,
                                                ngx_http_variable_value_t *v,
                                                uintptr_t data);
static ngx_int_t ngx_http_variable_normalized_request(
    ngx_http_request_t *r, ngx_http_variable_value_t *v, uintptr_t data);
#endif
...
static ngx_http_variable_t ngx_http_core_variables[] = {
...
#if (T_NGX_VARS)
    {ngx_string("full_request"), NULL, ngx_http_variable_full_request, 0, 0, 0},

    {ngx_string("normalized_request"), NULL,
     ngx_http_variable_normalized_request, 0, 0, 0},
#endif
...
#if (T_NGX_VARS)
    {ngx_string("dollar"), NULL, ngx_http_variable_dollar, 0, 0, 0},

    {ngx_string("host_comment"), NULL, ngx_http_variable_host_comment, 0, 0, 0},

    {ngx_string("unix_time"), NULL, ngx_http_variable_unix_time, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("year"), NULL, ngx_http_variable_year, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("year2"), NULL, ngx_http_variable_year2, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("month"), NULL, ngx_http_variable_month, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("day"), NULL, ngx_http_variable_day, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("hour"), NULL, ngx_http_variable_hour, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("hour12"), NULL, ngx_http_variable_hour12, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("minute"), NULL, ngx_http_variable_minute, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("second"), NULL, ngx_http_variable_second, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},

    {ngx_string("time_http"), NULL, ngx_http_variable_time_http, 0,
     NGX_HTTP_VAR_NOCACHEABLE, 0},
#endif
    ...
    {ngx_string("base64_decode_"), NULL, ngx_http_variable_decode_base64, 0,
     NGX_HTTP_VAR_PREFIX, 0},

    {ngx_string("md5_encode_"), NULL, ngx_http_variable_md5, 0,
     NGX_HTTP_VAR_PREFIX, 0},

    {ngx_string("escape_uri_"), NULL, ngx_http_variable_escape_uri, 0,
     NGX_HTTP_VAR_PREFIX, 0},

    {ngx_string("ascii_"), NULL, ngx_http_variable_ascii, 0,
     NGX_HTTP_VAR_PREFIX, 0},

    {ngx_string("sent_cookie_"), NULL, ngx_http_variable_sent_cookie, 0,
     NGX_HTTP_VAR_PREFIX, 0},
...
static ngx_int_t
ngx_http_variable_cookies(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                          uintptr_t data)
{
                          ...
                          uintptr_t data)
{
    ...
    switch (data)
    {
    case 0: value = ti.tcpi_rtt; break;

    case 1: value = ti.tcpi_rttvar; break;

    case 2: value = ti.tcpi_snd_cwnd; break;

    case 3: value = ti.tcpi_rcv_space; break;
...
static ngx_int_t
ngx_http_variable_scheme(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                         uintptr_t data)
{
#if (NGX_HTTP_SSL)
...
static ngx_int_t
ngx_http_variable_https(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                        uintptr_t data)
{
#if (NGX_HTTP_SSL)
...
static void
ngx_http_variable_set_args(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                           uintptr_t data)
{
    r->args.len           = v->len;
    r->args.data          = v->data;
...
static ngx_int_t
ngx_http_variable_is_args(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                          uintptr_t data)
{
    if (r->args.len == 0)
    {
...
static ngx_int_t
ngx_http_variable_pipe(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                       uintptr_t data)
{
...
static ngx_int_t
ngx_http_variable_status(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                         uintptr_t data)
{
    ngx_uint_t status;
...
static ngx_int_t
ngx_http_variable_hostname(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                           uintptr_t data)
{
...
static ngx_int_t
ngx_http_variable_pid(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                      uintptr_t data)
{
    u_char *p;
...
static ngx_int_t
ngx_http_variable_msec(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                       uintptr_t data)
{
    u_char     *p;
    ngx_time_t *tp;
...
static ngx_int_t
ngx_http_variable_ascii(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                        uintptr_t data)
{
    ngx_str_t *name = (ngx_str_t *)data;
                               ...
                               ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    if (p > 0 && p < 65536
        && ((p != 80 && scheme.len == 7) || (p != 443 && scheme.len == 8)))
    {
                                     ...
                                     uintptr_t                  data)
{
    ...
    s = ngx_strlchr(r->unparsed_uri.data, r->unparsed_uri.data + len, '#');
    if (s != NULL)
    {
...
static ngx_int_t
ngx_http_variable_dollar(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                         uintptr_t data)
{
    v->len          = 1;
    v->valid        = 1;
                               ...
                               ngx_http_variable_value_t *v, uintptr_t data)
{
    ...
    len = sizeof("<!-- ") - 1 + ngx_cached_http_time.len + 1
          + ngx_cycle->hostname.len + sizeof(" -->" CRLF) - 1;
...
static ngx_int_t
ngx_http_variable_unix_time(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                            uintptr_t data)
{
    u_char *p;
...
static ngx_int_t
ngx_http_variable_year(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                       uintptr_t data)
{
    return ngx_http_variables_time_fmt(r, v, ngx_cached_tm->ngx_tm_year,
                                       NGX_INT32_LEN);
}


static ngx_int_t
ngx_http_variable_year2(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                        uintptr_t data)
{
    return ngx_http_variables_time_fmt(r, v, ngx_cached_tm->ngx_tm_year % 100,
                                       2);
}


static ngx_int_t
ngx_http_variable_month(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                        uintptr_t data)
{
...
static ngx_int_t
ngx_http_variable_day(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                      uintptr_t data)
{
...
static ngx_int_t
ngx_http_variable_hour(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                       uintptr_t data)
{
...
static ngx_int_t
ngx_http_variable_hour12(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                         uintptr_t data)
{
    ngx_int_t hour;
...
static ngx_int_t
ngx_http_variable_minute(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                         uintptr_t data)
{
...
static ngx_int_t
ngx_http_variable_second(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                         uintptr_t data)
{
...
static ngx_int_t
ngx_http_variable_time_http(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                            uintptr_t data)
{
    u_char *p;
...
static ngx_int_t
ngx_http_variables_time_fmt(ngx_http_request_t *r, ngx_http_variable_value_t *v,
                            ngx_int_t t, ngx_int_t len)
{
    u_char *p;
