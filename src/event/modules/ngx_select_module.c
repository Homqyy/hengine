                          ...
                          ngx_uint_t flags)
{
    ...
    if (cycle->log->log_level & NGX_LOG_DEBUG_ALL)
    {
        ...
        ngx_log_debug1(NGX_LOG_DEBUG_EVENT, cycle->log, 0, "max_fd: %i",
                       max_fd);
    }
#endif
    ...
    ngx_log_debug1(NGX_LOG_DEBUG_EVENT, cycle->log, 0, "select timer: %M",
                   timer);
    ...
    ngx_log_debug1(NGX_LOG_DEBUG_EVENT, cycle->log, 0, "select ready %d",
                   ready);
