...
ngx_event_pipe_read_upstream(ngx_event_pipe_t *p)
{
    ...
    for (;;)
    {
        ...
        if (p->preread_bufs)
        {
            ...
            ngx_log_debug1(NGX_LOG_DEBUG_EVENT, p->log, 0, "pipe preread: %z",
                           n);
    ...
    ngx_log_debug1(NGX_LOG_DEBUG_EVENT, p->log, 0, "pipe length: %O",
                   p->length);
    ...
    if (!p->cacheable)
    {
        ...
        do
        {
            ...
            ngx_log_debug4(NGX_LOG_DEBUG_EVENT, p->log, 0,
                           ...
                           cl->buf->last_shadow, cl->buf->start, cl->buf->pos,
                           bsize);
