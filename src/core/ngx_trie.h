...
typedef ngx_trie_node_t *(*ngx_trie_insert_pt)(ngx_trie_t *trie, ngx_str_t *str,
                                               ngx_uint_t mode);
typedef ngx_int_t (*ngx_trie_build_clue_pt)(ngx_trie_t *trie);
typedef void *(*ngx_trie_query_pt)(ngx_trie_t *trie, ngx_str_t *str,
                                   ngx_int_t *pos, ngx_uint_t mode);
