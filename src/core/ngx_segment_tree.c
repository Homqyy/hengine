...
{
    tree->segments =
        ngx_pcalloc(pool, ((num + 1) << 2) * sizeof(ngx_segment_node_t));
...
void
ngx_segment_tree_delete(ngx_segment_tree_t *tree, ngx_int_t index, ngx_int_t l,
                        ngx_int_t r, ngx_int_t pos)
{
    ngx_int_t child, mid;
