                                           ...
                                           lua_State               *L)
{
    ...
    rc = ngx_http_lua_cache_loadbuffer(
        r->connection->log, L, lscf->srv.ssl_sess_fetch_src.data,
        lscf->srv.ssl_sess_fetch_src.len, lscf->srv.ssl_sess_fetch_src_key,
                                   ...
                                   void *conf)
{
    ...
    else
    {
        ...
        p = ngx_palloc(cf->pool, sizeof("ssl_session_fetch_by_lua")
