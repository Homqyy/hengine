...
#if (NGX_HTTP_SSL)
ngx_int_t ngx_http_lua_ssl_sess_fetch_handler_inline(
    ngx_http_request_t *r, ngx_http_lua_srv_conf_t *lscf, lua_State *L);

ngx_int_t ngx_http_lua_ssl_sess_fetch_handler_file(
    ngx_http_request_t *r, ngx_http_lua_srv_conf_t *lscf, lua_State *L);
...
ngx_ssl_session_t *ngx_http_lua_ssl_sess_fetch_handler(ngx_ssl_conn_t *ssl_conn,
