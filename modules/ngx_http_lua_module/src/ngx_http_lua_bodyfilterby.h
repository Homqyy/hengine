...
ngx_int_t ngx_http_lua_body_filter_by_chunk(lua_State *L, ngx_http_request_t *r,
                                            ngx_chain_t *in);
ngx_int_t ngx_http_lua_body_filter_inline(ngx_http_request_t *r,
                                          ngx_chain_t        *in);
ngx_int_t ngx_http_lua_body_filter_file(ngx_http_request_t *r, ngx_chain_t *in);
