...
#define ngx_hton64(x) NGX_BSWAP_64(x)

#define ngx_ntoh64(x) NGX_BSWAP_64(x)
...
ngx_chain_t *ngx_http_tfs_chain_get_free_buf(ngx_pool_t *p, ngx_chain_t **free,
                                             size_t size);
...
ngx_int_t ngx_http_tfs_peer_set_addr(ngx_pool_t                     *pool,
                                     ngx_http_tfs_peer_connection_t *p,
