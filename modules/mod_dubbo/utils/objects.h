...
class Object {
  public:
    ...
    void
    set_classname(const std::string &classname)
    {
...
class NullObject : public Object {
  public:
    ...
    NullObject(const std::string &classname = "null")
...
class Reference : public Object {
  public:
    ...
    Reference(data_type value)
        : Object(value->classname(), TYPE_ID), _value(value),
          _chain_delete(false)
    {
    }
    Reference(data_type value, const std::string &classname,
    ...
    ~Reference()
    {
        if (_chain_delete) delete _value;
    }
 ...
 * object like "[Ljava.lang.Class;", "[Ljava.lang.Object;",
 * "[Ljava.lang.String;" maybe like "[java.lang.Class", "[object", "[string",
...
class List : public Object {
  public:
    ...
    List(const std::string &classname = DEFAULT_CLASSNAME,
     ...
     * invoker make sure recycle memory, if detachment is not auto recycle
     * return null
     */
...
template <>
inline bool
instance_of<List>(const Object *obj)
{
    return obj
           && (obj->type_id() == List::TYPE_ID
               || (obj->type_id() >= Object::EXT_LIST
                   && obj->type_id() < Object::EXT_MAP));
}

template <>
inline bool
pointer_of<List>(const Object *obj)
{
    return !obj
           || (obj->type_id() == List::TYPE_ID
               || (obj->type_id() >= Object::EXT_LIST
...
class object_ptr_less_comparator {
  public:
    bool operator()(const Object *const &left,
                    const Object *const &right) const;
};
...
class Map : public Object {
  public:
    ...
    Map(const std::string &classname = DEFAULT_CLASSNAME,
        uint32_t           type_id   = TYPE_ID)
        : Object(classname, type_id)
    {
    }
    ...
    void    put(Object *key, Object *value, bool chain_delete_key = false,
                bool chain_delete_value = false);
...
template <>
inline bool
instance_of<Map>(const Object *obj)
{
    return obj
           && (obj->type_id() == Map::TYPE_ID
               || obj->type_id() >= Object::EXT_MAP);
}

template <>
inline bool
pointer_of<Map>(const Object *obj)
{
    return !obj
           || (obj->type_id() == Map::TYPE_ID
               || obj->type_id() >= Object::EXT_MAP);
...
class ObjectValue {
  public:
    ...
    ObjectValue(const char *c_char_ptr) : _type(C_CHAR_PTR)
    {
        _value.c_char_ptr = c_char_ptr;
    }
    ObjectValue(const std::string &str) : _type(C_STR_REF)
    {
        _value.c_str_ptr = &str;
    }
    ObjectValue(const std::string *c_str_ptr) : _type(C_STR_PTR)
    {
        _value.c_str_ptr = c_str_ptr;
    }
    ObjectValue(std::string *str_ptr) : _type(STR_PTR)
    {
        _value.str_ptr = str_ptr;
    }
...
class Exception : public Map {
  public:
    ...
    Exception(const std::string &detail_message = "",
              const std::string &classname      = DEFAULT_CLASSNAME)
    ...
    what() const
    {
        return _detail_message.c_str();
    }

    void
    set_cause(Exception *cause, bool chain_delete = false)
    {
        _cause = cause;
        if (cause && chain_delete) _delete_chain.push_back(cause);
    }
    const Exception *
    cause() const
    {
    ...
    void
    set_detail_message(const std::string &message)
    {
        _detail_message = message;
    }
    std::string *
    mutable_detail_message()
    {
        return &_detail_message;
    }
    const std::string &
    detail_message() const
    {
        return _detail_message;
    }

    void
    set_stack_trace(List *stack_trace, bool chain_delete = false)
    {
        _stack_trace = stack_trace;
        if (stack_trace && chain_delete) _delete_chain.push_back(stack_trace);
    }
    const List *
    stack_trace() const
    {
 ...
 */
template <class T> class ExtObject : public Object {
  public:
    typedef T                data_type;
    static const uint32_t    TYPE_ID;
    static const std::string DEFAULT_CLASSNAME;

    ExtObject(T *ptr, bool chain_delete = false,
              const std::string &classname = DEFAULT_CLASSNAME)
