...
static char     *ngx_http_footer_merge_loc_conf(ngx_conf_t *cf, void *parent,
                                                void *child);
...
static ngx_command_t ngx_http_footer_filter_commands[] = {
    ...
    {ngx_string("footer"),
     NGX_HTTP_MAIN_CONF | NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF
         | NGX_CONF_TAKE1,
     ngx_http_footer_filter, NGX_HTTP_LOC_CONF_OFFSET, 0, NULL},
...
ngx_http_footer_header_filter(ngx_http_request_t *r)
{
    ...
    if (lcf->variable == (ngx_http_complex_value_t *)-1 || r->header_only
        || (r->method & NGX_HTTP_HEAD) || r != r->main
